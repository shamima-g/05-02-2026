...
// Test 6: Story-level transition
test('Story-level transition sets phaseStatus to "ready"', () => {
  // First set total stories
  run('node .claude/scripts/transition-phase.js --set-total-stories 2 --epic 1');
