 ...
 * - lib/auth/auth-server.ts: requirePermission(), requireAnyRole()
 * - lib/auth/auth-helpers.ts: hasRole(), hasPermission(), hasAnyRole()
 */
...
export default async function ExampleProtectedPage(): Promise<React.ReactElement> {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="text-gray-600 mb-4">Your roles: {user?.roles.join(', ')}</p>
